...
_Real Estate Leads at Your Fingertips_

FSBO Finder utilizes `express`/`sequelize` and a frontend with
`react`/`redux`

## Setup

To Use FSBO Finder, you will need to set up a TWilio Account at https://www.twilio.com/. 

Enter your Client Secret, API Key, and Public Key into a secrets.js file in the root of the project.
